            ...
            switch (cmd)
            {
                case "connect":
                    ...
                    if (null != client)
                    {
                        ...
                        {
                            // 记录日志
                            Log.Info("MqttClientHelper$MqttClientConnectedHandlerDelegate -> clientId={}, state=ok",
                                clientId);
                        });
                        ...
                        {
                            // 记录日志
                            Log.Info("MqttClientHelper$MqttClientDisconnectedHandlerDelegate -> clientId={}, state=ok",
                                clientId);
                            ...
                            // 记录日志
                            Log.Info(
                                "MqttClientHelper$MqttClientDisconnectedHandlerDelegate -> clientId={}, reconnect=auto",
                                clientId);
                        });
                        ...
                        {
                            Log.Info("MqttClientHelper$ConnectAsync -> clientId={}, state=ok", clientId);
